        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Offer_Capacity", "\"Capacity\" > 0");
                    table.CheckConstraint("CK_Offer_EndDate", "\"EndDate\" >= \"StartDate\"");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    OfferSlotId = table.Column<int>(type: "integer", nullable: false),
                    OfferId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Booking_NumberOfPeople", "\"NumberOfPeople\" > 0");
                    table.ForeignKey(
                        name: "FK_Bookings_OfferSlots_OfferSlotId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_Phone_OfferId",
                table: "Bookings",
                columns: new[] { "Phone", "OfferId" });
